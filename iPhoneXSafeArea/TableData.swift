...
internal struct TableData {
    let icons = [#imageLiteral(resourceName: "unicorn"), #imageLiteral(resourceName: "poo"), #imageLiteral(resourceName: "panda"), #imageLiteral(resourceName: "fox"), #imageLiteral(resourceName: "chicken"), #imageLiteral(resourceName: "alien"), #imageLiteral(resourceName: "rabbit"), #imageLiteral(resourceName: "unicorn"), #imageLiteral(resourceName: "poo"), #imageLiteral(resourceName: "panda"), #imageLiteral(resourceName: "fox"), #imageLiteral(resourceName: "chicken"), #imageLiteral(resourceName: "alien"), #imageLiteral(resourceName: "rabbit"), #imageLiteral(resourceName: "unicorn"), #imageLiteral(resourceName: "poo"), #imageLiteral(resourceName: "panda"), #imageLiteral(resourceName: "fox"), #imageLiteral(resourceName: "chicken"), #imageLiteral(resourceName: "alien"), #imageLiteral(resourceName: "rabbit"), #imageLiteral(resourceName: "unicorn"), #imageLiteral(resourceName: "poo"), #imageLiteral(resourceName: "panda"), #imageLiteral(resourceName: "fox"), #imageLiteral(resourceName: "chicken"), #imageLiteral(resourceName: "alien"), #imageLiteral(resourceName: "rabbit")]
    let titles = [
